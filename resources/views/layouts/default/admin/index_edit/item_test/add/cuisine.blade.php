...
<form method="POST" action="{{ $action }}" {{--  class="form-inline" --}} role="form">
	...
	<div class="input-group">
		...
		data-placeholder="@lang($view.'.add_cat')" data-allow-clear="true"
		...
		<span class="input-group-append">
			...
			<button type="button" class="btn btn-default" data-toggle="modal" data-target="#myModalAjax" data-title="ordinamento" data-href="./order">
