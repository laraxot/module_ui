...
class Container_bb56117f0a extends _PHPStan_a3459023a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService046(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_bb56117f0a $container)
			{
	...
	public function createServiceContainer(): Container_bb56117f0a
	{
		return $this;
	}
