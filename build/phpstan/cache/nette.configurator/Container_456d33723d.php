...
class Container_456d33723d extends _PHPStan_a3459023a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService046(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_456d33723d $container)
			{
	...
	public function createServiceContainer(): Container_456d33723d
	{
		return $this;
	}
