    ...
    $.html5imageupload.prototype = {
            ...
            $(element).unbind('dragover drop mouseout').on(
                {
                    ...
                    mouseout: function () {
                        $(document).unbind('mouseup touchend').on(
        ...
        readImage: function (image, src, name, mimeType) {
            ...
            img.onload         = function (tmp) {
                ...
                _self.image            = $(imgElement).clone().data({ mime: mimeType, width: width, height: height, ratio: ratio, left: left, top: top, useWidth: useWidth, useHeight: useHeight}).addClass('main').bind(
        ...
        imageFinal: function () {
            ...
            if (options.download == true) {
                ...
                $(download).append(
                    $(_self.button.download).attr('download',$(_self.image).attr('name')).click(
                        function (e) {
