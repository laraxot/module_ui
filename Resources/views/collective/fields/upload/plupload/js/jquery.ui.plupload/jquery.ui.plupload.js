...
;(function (window, document, plupload, o, $) {
    ...
    /**
         ready
     {plupload.Uploader} uploader Uploader instance sending the event.
     */

    /**
         selected
     {plupload.Uploader} uploader Uploader instance sending the event.
     {Array} files Array of selected files represented by plupload.File objects
     */

    /**
         removed
     {plupload.Uploader} uploader Uploader instance sending the event.
     {Array} files Array of removed files represented by plupload.File objects
     */
    ...
    /**
         progress
     {plupload.Uploader} uploader Uploader instance sending the event.
     {plupload.File} file File that is being uploaded (includes loaded and percent properties among others).
     *
    ...
    /**
         uploaded
     {plupload.Uploader} uploader Uploader instance sending the event.
     {plupload.File} file File that was uploaded.
     *
    ...
    /**
         complete
     {plupload.Uploader} uploader Uploader instance sending the event.
     {Array} files Array of uploaded files represented by plupload.File objects
     */

    /**
         viewchanged
     {plupload.Uploader} uploader Uploader instance sending the event.
     {String} type Current view type.
     */
    ...
    $.widget(
        "ui.plupload", {
            ...
            _initUploader: function () {
                ...
                uploader.bind(
                    'QueueChanged StateChanged', function () {
                        self._handleState();
                    }
                );
         ...
         break;
            ...
            _displayThumbs: function () {
                ...
                function lazyLoad()
                {
                    ...
                    preloadThumb(
                        self.getFile($(thumbs.shift()).attr('id')), function () {
                            loading = false;
                            lazyLoad();
                        }
                    );
