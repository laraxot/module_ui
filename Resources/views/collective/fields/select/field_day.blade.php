@php
    ...
    $daynames = [trans('ui::txt.day_names.sun'), trans('ui::txt.day_names.mon'), trans('ui::txt.day_names.tue'), trans('ui::txt.day_names.wed'), trans('ui::txt.day_names.thu'), trans('ui::txt.day_names.fri'), trans('ui::txt.day_names.sat')];
@endphp
