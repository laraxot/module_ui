...
$qs = collect(request()->query())
    ...
    ->all();
if (!isset($class)) {
    $class = 'd-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search float-right';
}
@endphp
<form class="{{ $class }}" method="get">
    <div class="input-group">
        <input name="q" type="text" class="form-control  small" placeholder="Search for..."
